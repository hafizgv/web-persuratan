<body style="text-align: center; font-family: 'Times New Roman';">
    ...
    <div style="margin-top: 24pt; text-align: justify;">
        ...
        <div style="margin-top: 8pt; text-indent: 24pt;">
            Yang tersebut namanya adalah benar penduduk Gampong Beusa Seberang Kecamatan Peureulak Barat Kabupaten Aceh Timur. Menurut pengamatan kami benar ianya tergolong masyarakat <b>kurang mampu / miskin.</b>
        </div>
        <div style="margin-top: 8pt; text-indent: 24pt;">
