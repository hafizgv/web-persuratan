<body style="text-align: center; font-family: 'Times New Roman';">
    ...
    <div style="margin-top: 24pt; text-align: justify;">
        ...
        <div style="margin-top: 8pt; text-indent: 24pt;">
            Yang tersebut namanya adalah benar penduduk gampong Beusa Seberang Kecamatan Peureulak Barat Kabupaten Aceh Timur yang telah meninggal dunia pada Tanggal <?php echo htmlspecialchars($data['tanggal_meninggal']); ?>,
             dan sudah dikebumikan di <?php echo htmlspecialchars($data['tempat_dikebumikan']); ?>.
        </div>
        <div style="margin-top: 8pt; text-indent: 24pt;">
