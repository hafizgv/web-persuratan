...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            // Hitung total surat
            $total_query = "SELECT COUNT(*) as total FROM surat_keluar $where_clause"; 
            ...
            $query = "SELECT * FROM surat_keluar $where_clause LIMIT $limit OFFSET $offset";
            $result = $conn->query($query);
            ?>
            <div class="card table-container">
                <h3>List Surat Keluar</h3>
                <form method="GET" action="surat_keluar.php" class="filter-form">
